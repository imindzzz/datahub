...
@Slf4j
public class BusinessDescriptionUtils {
  private static final ConjunctivePrivilegeGroup ALL_PRIVILEGES_GROUP =
      new ConjunctivePrivilegeGroup(
          ImmutableList.of(PoliciesConfig.EDIT_ENTITY_PRIVILEGE.getType()));

  private BusinessDescriptionUtils() {}

  public static void updateFieldBusinessDescription(
      @Nonnull OperationContext opContext,
      String newBusinessDescription,
      Urn resourceUrn,
      String fieldPath,
      Urn actor,
    ...
    editableFieldInfo.setBusinessDescription(newBusinessDescription);
  ...
  public static Boolean validateFieldBusinessDescriptionInput(
      @Nonnull OperationContext opContext,
      Urn resourceUrn,
      String subResource,
  ...
  public static boolean isAuthorizedToUpdateFieldBusinessDescription(
